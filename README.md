...
│   ├── 01_cellchat_main_analysis.Rmd
│   └── 02_Seurat_gene_expression.Rmd
│
├── html_reports/         # Rendered HTML outputs from notebooks
│   ├── 01_cellchat_main_analysis.html
│   └── 02_Seurat_gene_expression.html
│
...
- Seurat (version 5.4.0 recommended)
- CellChat (version 2.2.0 recommended)
All other attached packages are in sessionInfo.txt
